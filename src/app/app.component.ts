...
export class AppComponent {
  ...
  Products:Product[] = [
      { id: 1, name: 'Nexus S', src: "/assets/img/phones/nexus-s.0.jpg", 
...
//       info: "The Motorola Xoom is an Android-based tablet computer by Motorola, introduced at CES 2011 on January 5, 2011. It was the first tablet to be sold with Android 3.0 Honeycomb. The Verizon branded Xoom was the first tablet to run Android 3.1. The Motorola Xoom went through the FCC on February 10, 2011 only 14 days before release." },
//       { id: 8, name: 'Samsung Galaxy Tab', src: "/assets/img/phones/samsung-galaxy-tab.0.jpg", 
//       info: "The Samsung Galaxy Tab is a line of upper mid-range Android-based tablet computers produced by Samsung Electronics. It is similar to the Samsung Galaxy Note series except without the Samsung S-Pen stylus.[1] The first model in the series, the 7-inch Samsung Galaxy Tab, was first introduced on 2 September 2010 at the IFA in Berlin." },